...
# Per saperne di più sulle interfacce in Go dai
# un'occhiata a questo [interessante articolo](http://jordanorelli.tumblr.com/post/32665860244/how-to-use-interfaces-in-go).
```
