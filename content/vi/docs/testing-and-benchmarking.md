...
```
```sh
# Chạy tất cả các test trong project hiện tại ở chế độ
# dài.
$ go test -v
== RUN   TestIntMinBasic
...
# Chạy tất cả các benchmark trong project hiện tại. Tất
# cả các test chạy độ ưu tiên để benchmark. Cờ `bench`
# lọc các tên hàm benchmark với regexp.
$ go test -bench=.
goos: darwin
goarch: arm64
